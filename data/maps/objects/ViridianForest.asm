	...
	const_export VIRIDIANFOREST_RIVAL_MALE
	const_export VIRIDIANFOREST_RIVAL_FEMALE
...
ViridianForest_Object:
	...
	IF DEF(_BLUE)
	object_event  1,  1, SPRITE_YELLOW, STAY, DOWN, TEXT_VIRIDIANFOREST_RIVAL_MALE
	object_event  1,  1, SPRITE_PINK, STAY, DOWN, TEXT_VIRIDIANFOREST_RIVAL_FEMALE
ELSE
	object_event  1,  1, SPRITE_RED, STAY, DOWN, TEXT_VIRIDIANFOREST_RIVAL_MALE
	object_event  1,  1, SPRITE_GREEN, STAY, DOWN, TEXT_VIRIDIANFOREST_RIVAL_FEMALE
ENDC
