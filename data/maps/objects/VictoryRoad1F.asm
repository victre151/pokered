	...
	const_export VICTORYROAD1F_RIVAL
...
VictoryRoad1F_Object:
	...
	object_event 11,  0, SPRITE_POKE_BALL, STAY, NONE, TEXT_VICTORYROAD1F_TM_SKY_ATTACK, TM_SEISMIC_TOSS
	...
	object_event  8, 14, SPRITE_BLUE, STAY, DOWN, TEXT_VICTORYROAD1F_RIVAL
