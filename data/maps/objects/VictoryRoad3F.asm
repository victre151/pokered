	...
	const_export VICTORYROAD3F_ARIANA
...
VictoryRoad3F_Object:
	...
	object_event  7,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_VICTORYROAD3F_TM_EXPLOSION, TM_PETAL_DANCE
	...
	object_event 2, 1, SPRITE_ROCKET, STAY, UP, TEXT_VICTORYROAD3F_ARIANA
