...
CeruleanCaveB1F_Object:
	...
	def_object_events
	IF DEF(_RED)
	object_event 27, 13, SPRITE_MONSTER, STAY, DOWN, TEXT_CERULEANCAVEB1F_MEWTWO, MEWTWO, 59
	ENDC
	IF DEF(_BLUE)
	object_event 27, 13, SPRITE_FAIRY, STAY, DOWN, TEXT_CERULEANCAVEB1F_MEWTWO, MEW, 59
	ENDC
