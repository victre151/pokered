	...
	const_export ROUTE15_RIVAL_MALE
	const_export ROUTE15_RIVAL_FEMALE
...
Route15_Object:
	...
	IF DEF(_BLUE)
	object_event  14, 8, SPRITE_YELLOW, STAY, NONE, TEXT_ROUTE15_RIVAL_MALE
	object_event  14, 8, SPRITE_PINK,   STAY, NONE, TEXT_ROUTE15_RIVAL_FEMALE
ELSE
	object_event  14, 8, SPRITE_RED,    STAY, NONE, TEXT_ROUTE15_RIVAL_MALE
	object_event  14, 8, SPRITE_GREEN,  STAY, NONE, TEXT_ROUTE15_RIVAL_FEMALE
ENDC
	object_event 18,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE15_TM_RAGE, TM_ROAR
