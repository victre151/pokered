...
IndigoPlateauHS:
	db INDIGO_PLATEAU, INDIGOPLATEAU_GUARD,		 HIDE
SaffronCityHS:
...
Route7HS:
	db ROUTE_7, ROUTE7_RIVAL_MALE, HIDE
	db ROUTE_7, ROUTE7_RIVAL_FEMALE, HIDE
Route9HS:
	db ROUTE_9, ROUTE9_TM_TELEPORT, SHOW
Route10HS:
	db ROUTE_10, ROUTE10_RIVAL_MALE, HIDE
	db ROUTE_10, ROUTE10_RIVAL_FEMALE, HIDE
	db ROUTE_10, ROUTE10_BLUE, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,    SHOW
	db ROUTE_12, ROUTE12_TM_PAY_DAY, SHOW
	db ROUTE_12, ROUTE12_IRON,       SHOW
Route15HS:
	db ROUTE_15, ROUTE15_RIVAL_MALE, HIDE
	db ROUTE_15, ROUTE15_RIVAL_FEMALE, HIDE
	db ROUTE_15, ROUTE15_TM_RAGE, SHOW
Route16HS:
	db ROUTE_16, ROUTE16_SNORLAX, SHOW
Route22HS:
	db ROUTE_22, ROUTE22_RIVAL1, HIDE
	db ROUTE_22, ROUTE22_RIVAL_MALE, HIDE
	db ROUTE_22, ROUTE22_RIVAL_FEMALE, HIDE
Route24HS:
...
OaksLabHS:
	...
	db OAKS_LAB, OAKSLAB_POKEDEX_RIVAL_MALE,   HIDE
	db OAKS_LAB, OAKSLAB_POKEDEX_RIVAL_FEMALE, HIDE
	
ViridianGymHS:
	db VIRIDIAN_GYM, VIRIDIANGYM_GIOVANNI, HIDE
	db VIRIDIAN_GYM, VIRIDIANGYM_OAK,	   HIDE
	db VIRIDIAN_GYM, VIRIDIANGYM_REVIVE,   SHOW
Museum1FHS:
	db MUSEUM_1F, MUSEUM1F_OLD_AMBER, SHOW
CeruleanCaveHS:
	db CERULEAN_CAVE_1F, CERULEANCAVE1F_RIVAL,         SHOW
...
PokemonMansion1FHS:
	db POKEMON_MANSION_1F, POKEMONMANSION1F_RIVAL_MALE,   HIDE
	db POKEMON_MANSION_1F, POKEMONMANSION1F_RIVAL_FEMALE, HIDE
...
PowerPlantHS:
	...
	db POWER_PLANT, POWERPLANT_ZAPDOS,     HIDE
	db POWER_PLANT, POWERPLANT_ARCHER,	   HIDE
	db POWER_PLANT, POWERPLANT_SILVER,	   HIDE
...
VictoryRoad2FHS:
	db VICTORY_ROAD_2F, VICTORYROAD2F_MOLTRES,       HIDE
...
ViridianForestHS:
	db VIRIDIAN_FOREST, VIRIDIANFOREST_RIVAL_MALE,   HIDE
	db VIRIDIAN_FOREST, VIRIDIANFOREST_RIVAL_FEMALE, HIDE
...
VictoryRoad3FHS:
	...
	db VICTORY_ROAD_3F, VICTORYROAD3F_ARIANA,		HIDE
RocketHideoutB1FHS:
...
VictoryRoad1FHS:
	db VICTORY_ROAD_1F, VICTORYROAD1F_RIVAL,         SHOW
...
LancesRoomHS:
	...
	db LANCES_ROOM, LANCESROOM_ARIANA, HIDE
ChampionsRoomHS:
	db CHAMPIONS_ROOM, CHAMPIONSROOM_RIVAL_MALE, HIDE
	db CHAMPIONS_ROOM, CHAMPIONSROOM_RIVAL_FEMALE, HIDE
	db CHAMPIONS_ROOM, CHAMPIONSROOM_OAK, HIDE
	db CHAMPIONS_ROOM, CHAMPIONSROOM_ARCHER, HIDE
SeafoamIslands1FHS:
...
SeafoamIslandsB4FHS:
	...
	db SEAFOAM_ISLANDS_B4F, SEAFOAM_B4F_GRUNT_L,  HIDE
	db SEAFOAM_ISLANDS_B4F, SEAFOAM_B4F_PROTON,   HIDE
	db SEAFOAM_ISLANDS_B4F, SEAFOAM_B4F_GRUNT_R,  HIDE
LoreleisRoomHS:
	db LORELEIS_ROOM, LORELEISROOM_LORELEI, SHOW
	db LORELEIS_ROOM, LORELEISROOM_SILVER, HIDE
BrunosRoomHS:
	db BRUNOS_ROOM, BRUNOSROOM_BRUNO, SHOW
	db BRUNOS_ROOM, BRUNOSROOM_PETREL, HIDE
AgathasRoomHS:
	db AGATHAS_ROOM, AGATHASROOM_AGATHA, SHOW
	db AGATHAS_ROOM, AGATHASROOM_PROTON, HIDE
	db $FF, $01, SHOW ; end
