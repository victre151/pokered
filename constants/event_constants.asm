...
; Viridian City events
	...
	const EVENT_VIRIDIAN_OLD_MAN_TUTORIAL_DONE
	const_skip 13
...
; Route 7 events
	const_next $420
	const_skip
	const EVENT_BEAT_ROUTE_7_RIVAL
...
; Route 10 events
	...
	const EVENT_BEAT_ROUTE_10_RIVAL
	const EVENT_BEAT_ROUTE_10_BLUE
...
; Route 15 events
	...
	const EVENT_BEAT_ROUTE_15_RIVAL
...
; Viridian Forest events
	...
	const EVENT_BEAT_VIRIDIAN_FOREST_RIVAL
...
; Pokémon Mansion events
	const_next $800
	const EVENT_BEAT_POKEMON_MANSION_1F_RIVAL
...
; Cerulean Cave events
	...
	const EVENT_BEAT_CERULEAN_CAVE_RIVAL
	const EVENT_BEAT_CERULEAN_CAVE_RIVAL_REMATCH
...
DEF INDIGO_PLATEAU_EVENTS_START EQU const_value
	...
	const EVENT_BEAT_LEAGUE_ROCKETS
	const_skip 4
	const_skip
...
; Victory Road 1F events
	...
	const EVENT_BEAT_VICTORY_ROAD_1F_RIVAL
...
; Post Game events
	...
	const EVENT_BEAT_KARATE_MASTER_REMATCH
	const EVENT_BEAT_SABRINA_REMATCH
	const EVENT_BEAT_ERIKA_REMATCH
	const EVENT_BEAT_KOGA_REMATCH
	const EVENT_SEAFOAM_ROCKETS_ARTICUNO
	const EVENT_SEAFOAM_ROCKETS_DONE
	const EVENT_BEAT_BLAINE_REMATCH
	const EVENT_BEAT_MISTY_REMATCH
	const EVENT_POWER_PLANT_ROCKETS_DONE
	const EVENT_POWER_PLANT_ROCKETS_ZAPDOS
	const EVENT_BEAT_LT_SURGE_REMATCH
	const EVENT_BEAT_BROCK_REMATCH
	const EVENT_BEAT_VIRIDIAN_GYM_OAK
	const EVENT_VICTORY_ROAD_ROCKETS_MOLTRES
	const EVENT_VICTORY_ROAD_ROCKETS_DONE
	const EVENT_OAKSLAB_POKEDEX_RIVAL_DONE
; End of events
	const_next $A00
