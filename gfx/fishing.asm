...
PinkFishingTilesFront:   INCBIN "gfx/overworld/pink_fish_front.2bpp"
PinkFishingTilesBack:    INCBIN "gfx/overworld/pink_fish_back.2bpp"
PinkFishingTilesSide:    INCBIN "gfx/overworld/pink_fish_side.2bpp"